...
4. To prevent pixel assets from rendering blurry, the default "Linear" texture filter setting needed to be changed to "Nearest" to ensure pixel assets aren't smoothed out and therefore blurry when rendered in-game. [Texture filter setting](https://github.com/nithinsenthil/UCDBTS/blob/89a5e8fe445850f593f16b975c6916b390f93217/ucdbts/project.godot#L126)
